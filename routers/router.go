...
func init() {
	...
	beego.Router("/vegetable/list", &controllers.VegetableController{}, "get:GetVegetableList")
	beego.Router("/vegetable/price", &controllers.VegetableController{}, "post:GetVegetablePrice")
